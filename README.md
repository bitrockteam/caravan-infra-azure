...
| <a name="provider_azurerm"></a> [azurerm](#provider\_azurerm) | 2.51.0 |
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_caravan_bootstrap"></a> [caravan\_bootstrap](#module\_caravan\_bootstrap) | git::ssh://git@github.com/bitrockteam/caravan-bootstrap | refs/tags/v0.2.1 |
...
| <a name="input_control_plane_disk_size"></a> [control\_plane\_disk\_size](#input\_control\_plane\_disk\_size) | The size of control plane instances disk. | `string` | `"40"` | no |
